...
@rem ##########################################################################
@rem
@rem  chess-server startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and CHESS_SERVER_OPTS to pass JVM options to this script.
...
@rem Execute chess-server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CHESS_SERVER_OPTS%  -classpath "%CLASSPATH%" chessserver.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable CHESS_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CHESS_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
